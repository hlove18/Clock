...
INIT:
    ...
    jb P1.4, init_cont0
        mov ALARM_STATE, #ALARM_ENABLED_STATE           ; alarm is enabled if P1.4 is low
        setb P1.6                                       ; turn on alarm light
        sjmp init_cont1

    init_cont0:
        mov ALARM_STATE, #ALARM_DISABLED_STATE          ; alarm is disabled if P1.4 is high
...
ALARM_ENABLED:
    jb P1.4, alarm_enabled_cont0                                        ; monitor the state of the alarm on/off switch
                                                                        ; alarm is enabled if P1.4 is low
    ...
    alarm_enabled_cont0:                                                ; alarm is disabled if P1.4 is high
        lcall ALARM_ENABLED_STATE_TO_ALARM_DISABLED_STATE               ; transistion to alarm disabled state
    alarm_enabled_cont1:
ret

ALARM_DISABLED:
    jb P1.4, alarm_disabled_cont0                                       ; monitor the state of the alarm on/off switch
                                                                        ; alarm is enabled if P1.4 is low
...
ALARM_FIRING:
    ...
    jnb P1.4, alarm_firing_cont0                                        ; monitor the state of the alarm on/off switch
        lcall ALARM_FIRING_STATE_TO_ALARM_DISABLED_STATE                ; alarm is disabled, so transition to alarm disabled state
    alarm_firing_cont0:
ret

ALARM_SNOOZING:
    jnb P1.4, alarm_snoozing_cont2
    ; jb P1.4, alarm_snoozing_cont0                                        ; monitor the state of the alarm on/off switch
    ;                                                                   ; alarm is enabled if P1.4 is low
    ...
    alarm_snoozing_cont0:                                               ; alarm is disabled if P1.4 is high
...
ENTER_DECA_FLASHING_STATE:
    ...
    jb P1.4, enter_deca_flashing_state_cont0
        ...
        lcall ALARM_SNOOZING_STATE_TO_ALARM_ENABLED_STATE   ; alarm is enabled if P1.4 is low

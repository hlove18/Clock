...
SERIAL_SERVICE:
	...
	cjne R3, #0Ah, serial_service_cont9
		...
		mov @R0, a 														; move the data in a into location R0 is pointing
		inc R0															; update R0 pointer to next memory location
		cjne R4, #0Bh, gps_wait_for_latitude_cont0 						; check if R4 (number of times we have looped) is equal to 11 (11 = number of received bytes for llll.llll,a)
